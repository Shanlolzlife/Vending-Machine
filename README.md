...
Test Case:
if it's a customer:
  user cannot choose a non existing drink
  once the drink is out of stock user cannot bug the system and keep choosing the drink
  when paying user cannot escape till the payment is made
  if the user tries to be funny and try to type anything than the actual input the system will respond with the necessary error message

if it is a vender:
  choice == 1: where vender is adding new drink
